...
import { renderBountiesTab, stopBountyTimers } from "./ui_bounties.js";
import {
  renderLichWeaponsTab,
  getFarmsSubview,
  setFarmsSubview,
  stopRotationTimers,
} from "../market/ui_lich_weapons.js";
...
export function renderFarmsTab() {
  ...
  if (view === "weapons") {
    // Simétrico a lo de abajo: el contador de las bounties seguiría latiendo cada segundo
    // contra nodos ocultos, y al rotar programaría refetches de una lista que nadie ve.
    stopBountyTimers();
    renderLichWeaponsTab();
  } else {
...
exposeGlobals({ switchFarmsSubview }, "ui.components/farms/ui_farms.js");

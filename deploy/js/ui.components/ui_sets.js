...
export function getPartRarity(partName) {
  ...
  if (drops && drops.length > 0) {
    ...
    drops.forEach((d) => {
      if (d.rarity) {
        ...
        if (r.includes("common")) hasCommon = true;
  ...
  // Fallback seguro usando la tabla de ducados oficial de Warframe (15d=Común, 45d=Incomún, 100d=Raro)

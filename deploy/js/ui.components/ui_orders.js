...
} from "../services/wfm_auth.service.js";
import {
    fetchMyOrders,
    editOrder,
    fetchItemMarket,
    fetchMarketBatch
} from "../services/wfm_orders.service.js";
...
async function fillInventorySection(body, orders) {
    ...
    let link;
    try {
        link = await import("../services/wfm_link.service.js");
...
function sellableRow(item, meta, market) {
    ...
    btn.addEventListener("click", async () => {
        ...
        const { createSellOrder } = await import("../services/wfm_link.service.js");
...
async function startLiveWatch(orders) {
    const { setWatchlist, startWatching, onUndercut, onDeal, onPrice } =
        await import("../services/wfm_watch.service.js");
...
async function refreshWatchlist(orders) {
    try {
        const { setWatchlist } = await import("../services/wfm_watch.service.js");
        setWatchlist(toWatchlist(orders));
...
export async function sellSetFromInventory(setName) {
    ...
    const link = await import("../services/wfm_link.service.js");
    linkApi = link;

...
import { sendSync, pollSync, isValidSyncCode } from "../../services/sync.service.js";
...
Object.assign(globalThis, {
  ...
  executeSyncSend: async function () {
    ...
    if (!isValidSyncCode(code)) return showToast("Código inválido (4 dígitos)");
    ...
    const res = await sendSync(code, msg);
    ...
    btn.innerText = res.reason === "rate-limit" ? "Límite (1min)" : t.error;

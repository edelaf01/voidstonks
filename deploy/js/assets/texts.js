...
export const TEXTS = {
  es: {
    ...
    scannerHUD: {
      ...
      hintNeural: "Red neuronal: lee de una pasada y acierta más (135 de 135 en las pruebas, frente a 133). Descarga 4,8 MB la primera vez.",
  ...
  en: {
    ...
    scannerHUD: {
      ...
      hintNeural: "Neural network: reads in one pass and gets more right (135 of 135 in testing, against 133). Downloads 4.8 MB the first time.",

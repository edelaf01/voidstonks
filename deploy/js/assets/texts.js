  ...
  es: {
    ...
    scannerCoach: {
      ...
      pasos: {
        ...
        motor: "El motor de lectura. El preciso acierta bastante más en la pantalla de recompensas, pero descarga un modelo la primera vez.",
    ...
    scannerHUD: {
      ...
      engineAsk: "¿DESCARGAR EL MODELO PRECISO?",
      engineAccept: "DESCARGAR · 6,4 MB",
      engineDecline: "AHORA NO",
      hintAsk: "Donde más se nota es en la pantalla de recompensas, que va con reloj: en las pruebas el modelo preciso acierta las 26 recompensas y el incluido 9. Se descarga una vez. Si dices que no, el escáner sigue funcionando con el motor incluido.",
      engineClassic: "CLÁSICO",
      engineNeural: "PRECISO",
      hintClassic: "Va incluido: no descarga nada y funciona sin conexión. Necesita probar varios ajustes por pantalla, así que trabaja más.",
      hintNeural: "Red neuronal: lee de una pasada. En la pantalla de recompensas acierta 26 de 26 frente a 9 del incluido. Modelo de 6,4 MB, se descarga una vez.",
  ...
  en: {
    ...
    scannerCoach: {
      ...
      pasos: {
        ...
        motor: "The reading engine. The precise one gets noticeably more right on the reward screen, but downloads a model the first time.",
    ...
    scannerHUD: {
      ...
      engineAsk: "DOWNLOAD THE PRECISE MODEL?",
      engineAccept: "DOWNLOAD · 6.4 MB",
      engineDecline: "NOT NOW",
      hintAsk: "It matters most on the reward screen, which is on a timer: in testing the precise model gets all 26 rewards and the built-in one gets 9. It downloads once. If you say no, the scanner keeps working with the built-in engine.",
      engineClassic: "CLASSIC",
      engineNeural: "PRECISE",
      hintClassic: "Ships with the app: downloads nothing and works offline. It has to try several settings per screen, so it works harder.",
      hintNeural: "Neural network: reads in one pass. On the reward screen it gets 26 of 26 against 9 for the built-in one. 6.4 MB model, downloaded once.",
